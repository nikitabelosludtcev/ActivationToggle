#
# Be sure to run `pod lib lint ActivationToggle.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ActivationToggle.'
...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'nikitabelosludtcev' => 'nikita@spentapp.com' }
  ...
  # s.resource_bundles = {
  #   'ActivationToggle' => ['ActivationToggle/Assets/*.png']
  # }
